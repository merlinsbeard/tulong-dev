...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BidChosen'
        db.create_table(u'bid_bidchosen', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('bid', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bid.Bid'])),
            ('date_chosen', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'bid', ['BidChosen'])


    def backwards(self, orm):
        # Deleting model 'BidChosen'
        db.delete_table(u'bid_bidchosen')
    ...
    models = {
        ...
        u'bid.bidchosen': {
            'Meta': {'object_name': 'BidChosen'},
            'bid': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bid.Bid']"}),
            'date_chosen': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
