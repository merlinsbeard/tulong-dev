...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'comment_comment', (
            ...
            ('commentor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='commentor', to=orm['person.Person'])),
            ('receiver', self.gf('django.db.models.fields.related.ForeignKey')(related_name='receiver', to=orm['person.Person'])),
