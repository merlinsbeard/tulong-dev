...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Comment.date_time_posted'
        db.add_column(u'comment_comment', 'date_time_posted',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Comment.date_time_posted'
        db.delete_column(u'comment_comment', 'date_time_posted')
    ...
    models = {
        ...
        u'comment.comment': {
            'Meta': {'ordering': "['receiver', '-date_time_posted']", 'object_name': 'Comment'},
            'comment': ('django.db.models.fields.TextField', [], {}),
            'commentor': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'commentor'", 'to': u"orm['person.Person']"}),
            'date_time_posted': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
