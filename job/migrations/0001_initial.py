...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('job', ['JobType'])

        # Adding model 'JobDuration'
        db.create_table('job_jobduration', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('duration_type', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50)),
        ))
        db.send_create_signal('job', ['JobDuration'])
        ...
        db.create_table('job_job', (
            ...
            ('job_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['job.JobType'])),
            ('is_payed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('date_need', self.gf('django.db.models.fields.DateTimeField')()),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('payment_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['payment.PaymentType'])),
            ('duration', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['job.JobDuration'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('job_jobtype')

        # Deleting model 'JobDuration'
        db.delete_table('job_jobduration')
