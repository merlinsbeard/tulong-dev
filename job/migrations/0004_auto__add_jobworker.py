...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'JobWorker'
        db.create_table(u'job_jobworker', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('worker', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['person.Person'])),
            ('job', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['job.Job'])),
        ))
        db.send_create_signal(u'job', ['JobWorker'])


    def backwards(self, orm):
        # Deleting model 'JobWorker'
        db.delete_table(u'job_jobworker')
