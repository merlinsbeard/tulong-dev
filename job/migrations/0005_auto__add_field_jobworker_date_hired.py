...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobWorker.date_hired'
        db.add_column(u'job_jobworker', 'date_hired',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 3, 24, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobWorker.date_hired'
        db.delete_column(u'job_jobworker', 'date_hired')
