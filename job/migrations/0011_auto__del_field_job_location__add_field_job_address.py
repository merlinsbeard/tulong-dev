...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'job_job', 'location')

        # Adding field 'Job.address'
        db.add_column(u'job_job', 'address',
                      self.gf('django.db.models.fields.TextField')(default='home'),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Job.location'
        db.add_column(u'job_job', 'location',
                      self.gf('django.db.models.fields.TextField')(default='home'),
                      keep_default=False)

        # Deleting field 'Job.address'
        db.delete_column(u'job_job', 'address')
