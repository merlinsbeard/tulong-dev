...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.gmap'
        db.add_column(u'job_job', 'gmap',
                      self.gf('django.db.models.fields.TextField')(default='14.625361,121.124482'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.gmap'
        db.delete_column(u'job_job', 'gmap')
