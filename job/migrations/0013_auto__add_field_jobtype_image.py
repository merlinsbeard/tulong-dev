...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobType.image'
        db.add_column(u'job_jobtype', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default='media/images/jobcat/default.jpg', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobType.image'
        db.delete_column(u'job_jobtype', 'image')
