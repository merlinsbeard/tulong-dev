...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'job_job', 'published')

        # Adding field 'Job.is_published'
        db.add_column(u'job_job', 'is_published',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'job_job', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Job.is_published'
        db.delete_column(u'job_job', 'is_published')
    ...
    models = {
        ...
        u'job.job': {
            ...
            'secret_detail': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
