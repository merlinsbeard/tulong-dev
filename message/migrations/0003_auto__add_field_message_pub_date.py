...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.pub_date'
        db.add_column(u'message_message', 'pub_date',
                      self.gf('django.db.models.fields.TimeField')(auto_now_add=True, default=datetime.datetime(2013, 4, 17, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.pub_date'
        db.delete_column(u'message_message', 'pub_date')
    ...
    models = {
        ...
        u'message.message': {
            ...
            'pub_date': ('django.db.models.fields.TimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
