...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.pub_date_time'
        db.add_column(u'message_message', 'pub_date_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 4, 22, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.pub_date_time'
        db.delete_column(u'message_message', 'pub_date_time')
