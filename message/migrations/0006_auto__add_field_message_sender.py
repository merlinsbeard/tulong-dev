...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'message_message', 'sender',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='sender', blank=True, to=orm['person.Person']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.sender'
        db.delete_column(u'message_message', 'sender_id')
    ...
    models = {
        ...
        u'message.message': {
            'Meta': {'ordering': "['-pub_date_time']", 'object_name': 'Message'},
            'content': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_read': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'pub_date_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'receiver': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['person.Person']"}),
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sender'", 'blank': 'True', 'to': u"orm['person.Person']"}),
