...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PersonClassification'
        db.create_table('person_personclassification', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('person_class', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('person', ['PersonClassification'])

        # Adding model 'Person'
        db.create_table('person_person', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('person_class', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['person.PersonClassification'])),
    ...
    def backwards(self, orm):
        # Deleting model 'PersonClassification'
        db.delete_table('person_personclassification')
