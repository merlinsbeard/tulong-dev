...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.firstname'
        db.add_column('person_person', 'firstname',
                      self.gf('django.db.models.fields.CharField')(default='hey', max_length=100),
                      keep_default=False)

        # Adding field 'Person.lastname'
        db.add_column('person_person', 'lastname',
    ...
    def backwards(self, orm):
        ...
        db.add_column('person_person', 'name',
                      self.gf('django.db.models.fields.CharField')(default=' ', max_length=100),
                      keep_default=False)

        # Deleting field 'Person.firstname'
        db.delete_column('person_person', 'firstname')

        # Deleting field 'Person.lastname'
        db.delete_column('person_person', 'lastname')
