...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.classification'
        db.add_column(u'person_person', 'classification',
                      self.gf('django.db.models.fields.CharField')(default='poster', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.classification'
        db.delete_column(u'person_person', 'classification')
