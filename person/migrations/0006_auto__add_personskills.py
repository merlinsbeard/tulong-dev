...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PersonSkills'
        db.create_table(u'person_personskills', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('skill', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50)),
        ))
        db.send_create_signal(u'person', ['PersonSkills'])

        # Adding M2M table for field skills on 'Person'
        db.create_table(u'person_person_skills', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('person', models.ForeignKey(orm[u'person.person'], null=False)),
            ('personskills', models.ForeignKey(orm[u'person.personskills'], null=False))
        ))
        db.create_unique(u'person_person_skills', ['person_id', 'personskills_id'])


    def backwards(self, orm):
        # Deleting model 'PersonSkills'
        db.delete_table(u'person_personskills')

        # Removing M2M table for field skills on 'Person'
        db.delete_table('person_person_skills')
