...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PersonBadge'
        db.create_table(u'person_personbadge', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('badge', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50)),
        ))
        db.send_create_signal(u'person', ['PersonBadge'])

        # Adding M2M table for field badge on 'Person'
        db.create_table(u'person_person_badge', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('person', models.ForeignKey(orm[u'person.person'], null=False)),
            ('personbadge', models.ForeignKey(orm[u'person.personbadge'], null=False))
        ))
        db.create_unique(u'person_person_badge', ['person_id', 'personbadge_id'])


        # Changing field 'Person.created_at'
        db.alter_column(u'person_person', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting model 'PersonBadge'
        db.delete_table(u'person_personbadge')

        # Removing M2M table for field badge on 'Person'
        db.delete_table('person_person_badge')


        # Changing field 'Person.created_at'
        db.alter_column(u'person_person', 'created_at', self.gf('django.db.models.fields.DateTimeField')())
