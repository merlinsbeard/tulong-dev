...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonBadge.image'
        db.add_column(u'person_personbadge', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default='hello.jpg', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonBadge.image'
        db.delete_column(u'person_personbadge', 'image')
