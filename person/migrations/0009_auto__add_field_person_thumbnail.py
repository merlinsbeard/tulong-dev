...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.thumbnail'
        db.add_column(u'person_person', 'thumbnail',
                      self.gf('django.db.models.fields.files.ImageField')(default='hmm.jpg', max_length=500, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.thumbnail'
        db.delete_column(u'person_person', 'thumbnail')
    ...
    models = {
        ...
        u'person.person': {
            ...
            'thumbnail': ('django.db.models.fields.files.ImageField', [], {'max_length': '500', 'blank': 'True'})
        },
