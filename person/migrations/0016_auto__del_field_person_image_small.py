...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Person.image_small'
        db.delete_column(u'person_person', 'image_small')


    def backwards(self, orm):
        # Adding field 'Person.image_small'
        db.add_column(u'person_person', 'image_small',
                      self.gf('django.db.models.fields.files.ImageField')(default='hmm', max_length=100, blank=True),
                      keep_default=False)
