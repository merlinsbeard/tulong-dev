...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.image_thumbnail'
        db.add_column(u'person_person', 'image_thumbnail',
                      self.gf('django.db.models.fields.files.ImageField')(default='media/images/default.jpg', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.image_thumbnail'
        db.delete_column(u'person_person', 'image_thumbnail')
    ...
    models = {
        ...
        u'person.person': {
            ...
            'image_thumbnail': ('django.db.models.fields.files.ImageField', [], {'default': "'media/images/default.jpg'", 'max_length': '100', 'blank': 'True'}),
