...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.contactno'
        db.alter_column(u'person_person', 'contactno', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Person.contactno'
        db.alter_column(u'person_person', 'contactno', self.gf('django.db.models.fields.CharField')(max_length=30))
